...
export default class Promise<T> implements Thenable<T> {
	 ...
	 */
	then<U>(onFulfilled?: ((value?: T) => (U | Thenable<U>)) | null | undefined, onRejected?: (reason?: Error) => void): Promise<U>;
	then<U>(onFulfilled?: ((value?: T) => (U | Thenable<U>)) | null | undefined, onRejected?: (reason?: Error) => (U | Thenable<U>)): Promise<U> {
